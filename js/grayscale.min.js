...
$(document).ready(function() {
    ...
    traitement(randIdentity(), 0);
    traitement(randIdentity(), 1);
    traitement(randIdentity(), 2);
    traitement(randIdentity(), 3);
    traitement(randIdentity(), 4);
    traitement(randIdentity(), 5);
    traitement(randIdentity(), 6);
    traitement(randIdentity(), 7);
